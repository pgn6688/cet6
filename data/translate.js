/* ===== 翻译数据(自动生成,勿手改;改 翻译/_gen_translate.py 后重跑) =====
   topics: 主题词包+整句  wordCats: 单词默写(按类别)  phraseCats: 短语默写(按类别)
   词条 {zh 中文, en 主答案, alt[] 可接受其它写法, pos 词性, hook 记忆钩子} */
window.TRANSLATE = {
 "topics": [
  {
   "id": "tea",
   ...
   "sentences": [
    {
     "zh": "中国是茶的故乡,茶文化有着悠久的历史。",
     "en": "China is the homeland of tea, and tea culture boasts a long history."
    },
    {
     "zh": "最初,茶被用作药物,后来才逐渐成为一种日常饮品。",
     "en": "At first, tea was used as medicine, and only later did it gradually become a daily beverage."
    },
    {
     "zh": "如今,饮茶已成为中国人待客的重要方式,也象征着尊重与友谊。",
     "en": "Nowadays, drinking tea has become an important way for Chinese people to entertain guests, and it also symbolizes respect and friendship."
    }
   ]
  },
  {
   ...
   "words": [
    ...
    {
     "zh": "自主研发",
     "en": "independently develop"
    }
   ],
   "sentences": [
    {
     "zh": "近年来,中国的高铁发展迅速,已成为世界上最大的高铁网络。",
     "en": "In recent years, China's high-speed rail has developed rapidly and has become the largest high-speed rail network in the world."
    },
    {
     "zh": "高铁大大缩短了城市之间的旅行时间,给人们的生活带来了极大便利。",
     "en": "High-speed rail has greatly shortened the travel time between cities and brought great convenience to people's lives."
    },
    {
     "zh": "它不仅促进了经济发展,也加强了偏远地区与外界的联系。",
     "en": "It has not only promoted economic development but also strengthened the connection between remote areas and the outside world."
    }
   ]
  },
  {
   ...
   "sentences": [
    {
     "zh": "过去几十年,中国在减贫方面取得了巨大成就。",
     "en": "Over the past few decades, China has made remarkable achievements in poverty alleviation."
    },
    {
     "zh": "政府采取了一系列措施来改善农村地区的生活水平。",
     "en": "The government has taken a series of measures to improve the living standards in rural areas."
    },
    {
     "zh": "通过发展教育和电子商务,数百万人摆脱了贫困。",
     "en": "Through developing education and e-commerce, millions of people have lifted themselves out of poverty."
    }
   ]
  }
 ],
 ...
 "phraseCats": [
  {
   ...
   "items": [
    ...
    {
     "zh": "平均海拔…米",
     "en": "have an average altitude of",
     "alt": [
      "stand at an average altitude of"
     ],
     "ex": {
   ...
   "items": [
    {
     ...
     "alt": [
      ...
      "be an important cornerstone of"
     ],
     "ex": {
  ...
  },
  {
   ...
   "items": [
    ...
    {
     "zh": "吸引大量游客,受到青睐",
     "en": "attract large numbers of tourists",
     "alt": [
      "be favored by"
     ],
     "ex": {
